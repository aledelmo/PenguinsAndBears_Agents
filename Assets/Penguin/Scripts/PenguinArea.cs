...
public class PenguinArea : MonoBehaviour
{
    ...
    [Tooltip("The bear inside the area")]
    ...
    public void ResetArea()
    {
        ...
        PlacePenguin();
        PlaceBaby();
        PlaceBear(Academy.Instance.EnvironmentParameters.GetWithDefault("bear_speed", 2f));
    ...
    /// <summary>
    /// Place the bear in the area
    /// </summary>
    private void PlaceBear(float bearSpeed)
    {
        bear.transform.position = ChooseRandomPosition(transform.position, -45f, 45f, 4f, 9f) + Vector3.up * .5f;
        bear.transform.rotation = Quaternion.Euler(0f, 180f, 0f);
        bear.GetComponent<Bear>().bearSpeed = bearSpeed;
    }
